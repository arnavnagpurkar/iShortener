      ...
      <div className="py-8 text-zinc-100">
        <div className="container mx-auto">
          ...
          <div className="text-lg">
            ...
            <p className="mx-3 my-4">
              iShortener is an open-source project created by&nbsp;<Link href="https://github.com/arnavnagpurkar" target="_blank" className="text-blue-500 hover:text-blue-400 transition-all">Arnav Nagpurkar</Link>. It is built using Next.js and Tailwind CSS, leveraging the power of modern web technologies to provide a seamless and efficient URL shortening experience.
            </p>
            <p className="mx-3 my-4">
              You can contribute to its development or report issues on&nbsp;<Link href="https://github.com/arnavnagpurkar/iShortener" target="_blank" className="text-blue-500 hover:text-blue-400 transition-all">GitHub</Link>.
            </p>
            <p className='mx-3 my-4'>
